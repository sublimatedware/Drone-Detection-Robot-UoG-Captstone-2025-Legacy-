...
try:
    ...
    print("\nProgram Begin")
    while True:
        Y_destination = int(interp(mouse.position[1], [0,MAX_MOUSE_Y], [0,MAX_MOTOR_Y]))
        Z_destination = int(interp(mouse.position[0], [0,MAX_MOUSE_Z], [MAX_MOTOR_Z,0]))
        
        #print(Z_destination)
        #board_Z.stepper_get_current_position(motor_Z, motor_Z_current_position_callback) 
        #print(Y_destination)
        #board_Y.stepper_get_current_position(motor_Y, motor_Y_current_position_callback)
